...
#   define JEG_USE_DMA_MEMORY_COPY_ACCELERATION        ENABLED
#endif
...
#   define JEG_USE_EXTRA_16BIT_BUS_ACCESS              ENABLED
#endif
...
/*! \brief This switch is used to inverse the y axis in background buffer, it is
 *!        required for some special use cases. 
 */
#ifndef JEG_USE_INVERSE_Y_SCANLINE
#   define JEG_USE_INVERSE_Y_SCANLINE                   DISABLED
#endif
